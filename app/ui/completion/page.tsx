...
const CompletionPage = () => {
  ...
  const completeText = async (e: React.FormEvent) => {
    e.preventDefault();
      ...
      <div className="flex flex-col w-full max-w-2xl min-h-screen py-16 px-4 mx-auto">
        ...
        <main className="flex-1 flex flex-col gap-4">
          ...
          {completion && !isLoading && (
            <div
              className="p-6 rounded-2xl bg-white/90 dark:bg-zinc-800/90 border border-zinc-200/80 dark:border-zinc-700/50 shadow-lg shadow-zinc-200/50 dark:shadow-zinc-900/50 backdrop-blur-sm"
            >
